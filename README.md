...
`SimplyTremolo` in them will be replaced with the first argument given to `build.py` (e.g. "MyEffect"), and all text
files will be changed so that the strings `SimplyTremolo` and `trlo` are replaced with the values you
provided.
